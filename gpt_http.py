...
# Keep track of the conversation messages and selected model
messages = []
...
<body>
    <form method="post" action="/">
        ...
        <select id="model" name="model" onchange="this.form.submit()">
            ...
            <option value="gpt-4" {{ 'selected' if selected_model == 'gpt-4' else '' }}>GPT-4</option>
...
def web_shell():
    ...
    # Collect the last 5 user-bot message pairs for display in reverse order
